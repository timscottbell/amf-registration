...
public class AMFEventServiceHttp {
	public static java.util.List<com.liferay.amf.model.AMFEvent> getAMFEvents(
		...
		try {
			MethodKey methodKey = new MethodKey(AMFEventServiceUtil.class,
					"getAMFEvents", _getAMFEventsParameterTypes0);
			...
			return (java.util.List<com.liferay.amf.model.AMFEvent>)returnObj;
		}
	...
	public static int getAMFEventsCount(HttpPrincipal httpPrincipal,
		com.liferay.portal.kernel.service.ServiceContext serviceContext,
		int type) throws com.liferay.portal.kernel.exception.PortalException {
		try {
			MethodKey methodKey = new MethodKey(AMFEventServiceUtil.class,
					"getAMFEventsCount", _getAMFEventsCountParameterTypes1);
	...
	private static final Class<?>[] _getAMFEventsParameterTypes0 = new Class[] {
			com.liferay.portal.kernel.service.ServiceContext.class, int.class,
			int.class, int.class
		};
	private static final Class<?>[] _getAMFEventsCountParameterTypes1 = new Class[] {
			com.liferay.portal.kernel.service.ServiceContext.class, int.class
		};
}