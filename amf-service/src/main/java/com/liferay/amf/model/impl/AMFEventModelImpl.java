...
public class AMFEventModelImpl extends BaseModelImpl<AMFEvent>
	...
	public static final String TABLE_SQL_CREATE = "create table AMF_AMFEvent (amfEventId LONG not null primary key,userId LONG,userName VARCHAR(75) null,createTime LONG,type_ INTEGER,ipAddress VARCHAR(75) null)";
	...
	public static final String ORDER_BY_SQL = " ORDER BY AMF_AMFEvent.createTime DESC";
