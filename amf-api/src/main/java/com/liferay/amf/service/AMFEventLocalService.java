...
public interface AMFEventLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AMFEventLocalServiceUtil} to access the amf event local service. Add custom service methods to {@link com.liferay.amf.service.impl.AMFEventLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AMFEvent addAMFEvent(long userId, int type,
	...
	*/
	public AMFEvent createAMFEvent(long amfEventId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AMFEvent deleteAMFEvent(long amfEventId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AMFEvent fetchAMFEvent(long amfEventId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AMFEvent getAMFEvent(long amfEventId) throws PortalException;
